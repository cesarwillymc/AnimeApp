...
| Technology         | Logo                                                                                     |
|--------------------|------------------------------------------------------------------------------------------|
| GitHub             | <img src="image/icons/github.png" alt="GitHub Logo" height="250" style="max-width:100%; max-height:100%;">            |
| Coil               | <img src="image/icons/coil_android.svg" alt="Coil Logo"  height="250" style="max-width:100%; max-height:100%;">        |
| Dagger Hilt        | <img src="image/icons/hilt_dagger.jpeg" alt="Dagger Hilt Logo"  height="250" style="max-width:100%; max-height:100%;"> |
| JUnit              | <img src="image/icons/Junit.png" alt="JUnit Logo"  height="250" style="max-width:100%; max-height:100%;">              |
| Jetpack Compose    | <img src="image/icons/jetpack.png" alt="Jetpack Compose Logo" height="250" style="max-width:100%; max-height:100%;">  |
| Proguard R8        | <img src="image/icons/proguard.png" alt="Proguard R8 Logo" height="250" style="max-width:100%; max-height:100%;">     |
| Room               | <img src="image/icons/room_android.jpeg" alt="Room Logo"  height="250" style="max-width:100%; max-height:100%;">       |
